...
GenotypeFile <- read.csv("GWAS_trainset_afterBH_indiv_probe1_v2_genotype.csv")
...
cols_with_2_classes <- which(sapply(seq_len(3), function(col_idx) length(unique(test.set[[col_idx]])) == 2))
...
xgb.save(best.boost, "xgboost.gwas75.afterBH.indiv.model.non-genetic.probe1")
...
GenotypeFile <- read.csv("GWAS_trainset_afterBH_indiv_probe3_snps_MAF10_genotype.csv")
...
## step 3
# Find columns in test.set that have only 2 unique values
cols_with_2_classes <- which(sapply(seq_len(12), function(col_idx) length(unique(test.set[[col_idx]])) == 2))
...
#predict on test.set without last row of dummy variables
elastic.pred <- predict(elastic, newdata = test.set[,1:24])
...
set.seed(123)
best.boost <- xgboost(data=dtrain_mQTL, params=best.param, nrounds=nround, verbose = FALSE)
xgb.save(best.boost, "xgboost.gwas75.afterBH.indiv.model.non-genetic.probe3")
...
GenotypeFile <- read.csv("GWAS_trainset_afterBH_indiv_probe4_snps_MAF10_genotype.csv")
...
## step 3
# Find columns in test.set that have only 2 unique values
cols_with_2_classes <- which(sapply(seq_len(4), function(col_idx) length(unique(test.set[[col_idx]])) == 2))
...
set.seed(123)
best.boost <- xgboost(data=dtrain_mQTL, params=best.param, nrounds=nround, verbose = FALSE)
xgb.save(best.boost, "xgboost.gwas75.afterBH.indiv.model.non-genetic.probe4")
...
GenotypeFile <- read.csv("GWAS_trainset_afterBH_indiv_probe5_snps_MAF10_genotype.csv")
...
## step 3
# Find columns in test.set that have only 2 unique values
cols_with_2_classes <- which(sapply(seq_len(7), function(col_idx) length(unique(test.set[[col_idx]])) == 2))
...
#predict on test.set without last row of dummy variables
elastic.pred <- predict(elastic, newdata = test.set[,1:20])
...
set.seed(123)
best.boost <- xgboost(data=dtrain_mQTL, params=best.param, nrounds=nround, verbose = FALSE)
xgb.save(best.boost, "xgboost.gwas75.afterBH.indiv.model.non-genetic.probe5")
...
GenotypeFile <- read.csv("GWAS_trainset_afterBH_indiv_probe7_snps_MAF10_genotype.csv")
...
## step 3
# Find columns in test.set that have only 2 unique values
cols_with_2_classes <- which(sapply(seq_len(2), function(col_idx) length(unique(test.set[[col_idx]])) == 2))
...
#predict on test.set without last row of dummy variables
elastic.pred <- predict(elastic, newdata = test.set[,1:14])
...
set.seed(123)
best.boost <- xgboost(data=dtrain_mQTL, params=best.param, nrounds=nround, verbose = FALSE)
xgb.save(best.boost, "xgboost.gwas75.afterBH.indiv.model.non-genetic.probe7")
