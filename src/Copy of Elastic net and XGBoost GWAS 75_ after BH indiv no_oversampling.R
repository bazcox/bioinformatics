...
elastic.pred <- predict(elastic, newdata = test.set[,1:2])
...
xgb.save(best.boost, "xgboost.gwas75.afterBH.indiv.model.probe1")
...
library(readxl)
#1. Read Genotype PED file and 1st CYP2D6 CpG probe cg04692870
...
#predict on test.set without last row of dummy variables
elastic.pred <- predict(elastic, newdata = test.set[,1:11])
...
set.seed(123)
best.boost <- xgboost(data=dtrain_mQTL, params=best.param, nrounds=nround, verbose = FALSE)
xgb.save(best.boost, "xgboost.gwas75.afterBH.indiv.model.probe3")
...
eval_results (test.set$cg09322432, xgboost_predictions, xgboost_predictions) #test
...
set.seed(123)
best.boost <- xgboost(data=dtrain_mQTL, params=best.param, nrounds=nround, verbose = FALSE)
xgb.save(best.boost, "xgboost.gwas75.afterBH.indiv.model.probe4")
...
eval_results (test.set$cg10840135, xgboost_predictions, xgboost_predictions) #test
...
#predict on test.set without last row of dummy variables
elastic.pred <- predict(elastic, newdata = test.set[,1:7])
...
set.seed(123)
best.boost <- xgboost(data=dtrain_mQTL, params=best.param, nrounds=nround, verbose = FALSE)
xgb.save(best.boost, "xgboost.gwas75.afterBH.indiv.model.probe5")
...
eval_results (test.set$cg15597984, xgboost_predictions, xgboost_predictions) #test
...
#predict on test.set without last row of dummy variables
elastic.pred <- predict(elastic, newdata = test.set[1])
...
set.seed(123)
best.boost <- xgboost(data=dtrain_mQTL, params=best.param, nrounds=nround, verbose = FALSE)
xgb.save(best.boost, "xgboost.gwas75.afterBH.indiv.model.probe7")
...
eval_results (test.set$cg20046859, xgboost_predictions, xgboost_predictions) #test
